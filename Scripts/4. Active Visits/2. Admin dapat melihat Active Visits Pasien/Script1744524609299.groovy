...
WebUI.click(findTestObject('Object Repository/Page_Home/a_Active Visits (1)'))

WebUI.navigateToUrl('https://o2.openmrs.org/openmrs/coreapps/activeVisits.page?app=coreapps.activeVisits')

WebUI.setText(findTestObject('Object Repository/Page_OpenMRS Electronic Medical Record/input_search (1)'), 'irman ramadhan')

WebUI.click(findTestObject('Object Repository/Page_OpenMRS Electronic Medical Record/a_irman ramadhan ZPNWq2sg (1)'))
...
WebUI.verifyElementText(findTestObject('Page_ActiveVisits/CurrentVisitActions'), 'Current Visit Actions')

WebUI.verifyElementText(findTestObject('Object Repository/Page_OpenMRS Electronic Medical Record/div_End Visit'), 'End Visit')
